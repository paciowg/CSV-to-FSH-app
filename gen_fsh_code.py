...
def process_list_case(key_name, variable_list, dict, line, fsh_lines):
    ...
    for idx, item in enumerate(item_list): 
        ...
        variable = variable_list[var_idx+1]                    
    ...
    for lookup_data_dict in other_lookup_data:
        ...
        for variable in variable_list[idx:]:
            ...
            if key_name2 in lookup_data_dict:
                ...
                process_list_case(key_name2, variable_list[idx:], lookup_data_dict, line2, fsh_lines)
                skip_line = True
        ...
        for line in template_obj['lines']:
            ...
            for variable in variable_list:
                ...
                if key_name in instance_data:
                    ...
                    process_list_case(key_name, variable_list, instance_data, line, fsh_lines)
...
def run_jobs(context):
    ...
    for job in configs['jobs']:
        ...
        # read and parse other input files
